  ...
  connectedCallback() {
    ...
    <ul class="categories list-unstyled">
      <li class="menu-inicio">
        <i class="fas fa-home"></i><a href="dashboard-master.html"> Início</a>
      </li>
      ...
      <li class="menu-agencias" data-modal="agenciasModal">
        ...
        <ul class="sidebar-dropdown list-unstyled">
          <li><a href="/agencias/master/cadastrar/">Nova unidade</a></li>
          <li><a href="/agencias/master/lista/">Listar unidades</a></li>
        </ul>
      </li>
    ...
    <div class="modal-content">
          ...
          <div class="row" style="gap:5px;padding-left: 20px; padding-right: 20px;">
              <div class="col d-flex flex-column align-items-center justify-content-center flex-collum" style="height:100px;background-color: #ebebeb;border-radius:10px;">
                  ...
                  <a href="/agencias/master/lista/" style="color:#787878;">Agências</a>
              </div>
              <div class="col d-flex flex-column align-items-center justify-content-center flex-collum" style="height:100px;background-color: #ebebeb;border-radius:10px;">
              ...
              <div class="col d-flex flex-column align-items-center justify-content-center flex-collum" style="height:100px;background-color: #ebebeb;border-radius:10px;">
                  ...
                  <a href="/agencias/master/cadastrar/" style="color:#787878;">Nova Agências</a>
              </div> 
          </div>
          </div>
        </div>
